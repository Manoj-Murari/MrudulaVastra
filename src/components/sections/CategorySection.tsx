// Server component — no "use client" needed, zero JS shipped for this section
    ...
    <section className="bg-cream font-dm py-10 lg:py-16 px-5 sm:px-10 overflow-hidden w-full max-w-[100vw]">
      <div className="max-w-5xl lg:max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 lg:mb-16 animate-fade-up">
          <p className="uppercase font-bold mb-4 text-gold tracking-[0.5em] text-[9px]">
            The Curations
          </p>
          <h2 className="font-playfair text-forest font-medium tracking-wide text-[24px] sm:text-[clamp(24px,3.2vw,40px)]">
            Shop by Category
          </h2>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <div className="text-center">
                  <h3 className="font-playfair text-forest font-medium text-[15px] sm:text-2xl lg:text-[26px] mb-1.5 sm:mb-2 tracking-wide group-hover:text-gold transition-colors duration-500">
                    {cat.title}
                  </h3>
                  {/* Shop label — visible on all screen sizes */}
                  <div className="flex flex-col items-center">
                    <p className="text-[10px] sm:text-[10px] uppercase tracking-[0.3em] font-black text-gold/70 group-hover:text-gold transition-colors duration-500">
                      Shop Now →
                    </p>
