      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[380px] bg-cream shadow-[0_20px_60px_rgba(0,0,0,0.3)] z-10 overflow-hidden flex flex-col"
          >
            {/* Top Image Section */}
            <div className="relative w-full h-[280px]">
              {/* Note: Ensure the image exists in public/images/ */}
              <img
